    ...
    def do_add_parser(self, parser_adder):
        ...
        pip_parser = subparsers_gen.add_parser(
            ...
            Manage pip packages:
                ...
                Run 'west uv pip' to print all requirement files needed by
                Zephyr and modules.
        ...
        pip_parser.add_argument(
            ...
            "from the original 'west uv pip --install' command. For example pass "
        ...
        pip_parser.add_argument(
            ...
            "This is useful when running 'west uv pip --install' "
