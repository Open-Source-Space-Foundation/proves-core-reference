...
static const struct gpio_dt_spec muxResetGpio = GPIO_DT_SPEC_GET(DT_NODELABEL(mux_reset), gpios);
...
void configureTopology() {
    ...
    muxReset.open(muxResetGpio, Zephyr::ZephyrGpioDriver::GpioConfiguration::OUT);
