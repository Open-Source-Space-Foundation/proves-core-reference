...
#include "PROVESFlightControllerReference/ComCcsdsUart/Ports_ComBufferQueueEnumAc.hpp"
#include "PROVESFlightControllerReference/ComCcsdsUart/Ports_ComPacketQueueEnumAc.hpp"

// Include autocoded FPP constants
#include "PROVESFlightControllerReference/ReferenceDeployment/Top/FppConstantsAc.hpp"
...
struct TopologyState {
    ...
    const device* loraDevice;  //!< LoRa device path for communication (not present on the USP build)
#endif
