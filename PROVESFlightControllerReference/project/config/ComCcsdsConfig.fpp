module ComCcsdsConfig {
    ...
    module StackSizes {
        constant comQueue            = 4 * 1024 # Must match CONFIG_DYNAMIC_THREAD_STACK_SIZE in prj.conf
        constant aggregator          = 4 * 1024 # Must match CONFIG_DYNAMIC_THREAD_STACK_SIZE in prj.conf
    }
