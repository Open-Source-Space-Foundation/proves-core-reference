...
#ifndef PROVESFlightControllerReference_PayloadCom_HPP
#define PROVESFlightControllerReference_PayloadCom_HPP

#include "PROVESFlightControllerReference/Components/PayloadCom/PayloadComComponentAc.hpp"
