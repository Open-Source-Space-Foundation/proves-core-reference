...
def test_11_proc_toggle(fprime_test_api: IntegrationTestAPI, start_gds):
    ...
    # fprime_test_api.assert_event(f"{rtcManager}.TimeBase", start="NOW", timeout=10)
    ...
    # # Assert that we receive a TimeBaseInvalid event within 10 seconds
    # fprime_test_api.assert_event(f"{rtcManager}.InvalidTimeBase", start="NOW", timeout=10)
