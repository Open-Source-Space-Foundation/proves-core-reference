"""
z_lora_passthrough_test.py:

Smoke test for the downlink LoRa radio path via the v5d CircuitPython
passthrough board (code-lora.py). Enables TRANSMIT on the v5e flight
controller, then reads raw bytes from the passthrough's USB CDC data
