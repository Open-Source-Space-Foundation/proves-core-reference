module ReferenceDeployment {
  ...
  # ----------------------------------------------------------------------
    ...
    connections RateGroups {
      ...
      rateGroup1Hz.RateGroupMemberOut[15] -> adcs.run
      rateGroup1Hz.RateGroupMemberOut[16] -> thermalManager.run
      rateGroup1Hz.RateGroupMemberOut[17] -> detumbleManager.run
    }
