...
def stop_burnwire(fprime_test_api: IntegrationTestAPI):
    fprime_test_api.send_and_assert_command(f"{COMPONENT}.STOP_BURNWIRE", max_delay=2)
...
def test_01_start_and_stop_burnwire(fprime_test_api: IntegrationTestAPI):
    ...
    # Start burnwire
    fprime_test_api.send_and_assert_command(f"{COMPONENT}.START_BURNWIRE", max_delay=2)
