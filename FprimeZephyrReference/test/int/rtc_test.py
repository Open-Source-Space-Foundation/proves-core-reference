...
#     # Fetch event data
#     result: EventData = fprime_test_api.assert_event(f"{rtc_manager}.TimeSet", timeout=2)
...
#         fprime_test_api.get_event_pred(f"{rtc_manager}.YearValidationFailed"),
#         fprime_test_api.get_event_pred(f"{rtc_manager}.MonthValidationFailed"),
#         fprime_test_api.get_event_pred(f"{rtc_manager}.DayValidationFailed"),
#         fprime_test_api.get_event_pred(f"{rtc_manager}.HourValidationFailed"),
#         fprime_test_api.get_event_pred(f"{rtc_manager}.MinuteValidationFailed"),
#         fprime_test_api.get_event_pred(f"{rtc_manager}.SecondValidationFailed"),
#         fprime_test_api.get_event_pred(f"{rtc_manager}.TimeNotSet"),
...
#         f"{rtc_manager}.TIME_SET", [time_data_str], events, timeout=10
#     )
