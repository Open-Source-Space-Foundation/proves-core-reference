...
# from wdk import lsm6dso_manager, lis2mdl_manager
...
#         f"{lsm6dsoManager}.Acceleration", start=start, timeout=65
#     )
#     result_angular_velocity: ChData = fprime_test_api.assert_telemetry(
#         f"{lsm6dsoManager}.AngularVelocity", start=start, timeout=65
#     )
#     result_temperature: ChData = fprime_test_api.assert_telemetry(
#         f"{lsm6dsoManager}.Temperature", start=start, timeout=65
#     )
#     result_magnetic_field: ChData = fprime_test_api.assert_telemetry(
#         f"{lis2mdlManager}.MagneticField", start=start, timeout=65
#     )
