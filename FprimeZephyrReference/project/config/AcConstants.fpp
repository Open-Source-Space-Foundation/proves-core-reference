# ======================================================================
# AcConstants.fpp
# Project-specific overrides for F Prime configuration constants
# Based on lib/fprime/default/config/AcConstants.fpp
# ======================================================================

@ Number of rate group member output ports for ActiveRateGroup
@ Increased from default 10 to 11 to support all rate group members
constant ActiveRateGroupOutputPorts = 11
