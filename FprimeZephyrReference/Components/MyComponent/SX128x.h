...
#define RADIOLIB_SX128X_SLEEP_DATA_RAM_FLUSH \
    0b00000000  //  0     0   data RAM (configuration) behavior in sleep mode: flush
#define RADIOLIB_SX128X_SLEEP_DATA_RAM_RETAIN \
    0b00000001  //  0     0                                                    retain
...
#define RADIOLIB_SX128X_BLE_GFSK_BR_2_000_BW_2_4 \
    0x04  //  7     0   GFSK/BLE bit rate and bandwidth setting: 2.0 Mbps   2.4 MHz
#define RADIOLIB_SX128X_BLE_GFSK_BR_1_600_BW_2_4 \
    0x28  //  7     0                                            1.6 Mbps   2.4 MHz
#define RADIOLIB_SX128X_BLE_GFSK_BR_1_000_BW_2_4 \
    0x4C  //  7     0                                            1.0 Mbps   2.4 MHz
#define RADIOLIB_SX128X_BLE_GFSK_BR_1_000_BW_1_2 \
    0x45  //  7     0                                            1.0 Mbps   1.2 MHz
#define RADIOLIB_SX128X_BLE_GFSK_BR_0_800_BW_2_4 \
    0x70  //  7     0                                            0.8 Mbps   2.4 MHz
#define RADIOLIB_SX128X_BLE_GFSK_BR_0_800_BW_1_2 \
    0x69  //  7     0                                            0.8 Mbps   1.2 MHz
#define RADIOLIB_SX128X_BLE_GFSK_BR_0_500_BW_1_2 \
    0x8D  //  7     0                                            0.5 Mbps   1.2 MHz
#define RADIOLIB_SX128X_BLE_GFSK_BR_0_500_BW_0_6 \
    0x86  //  7     0                                            0.5 Mbps   0.6 MHz
#define RADIOLIB_SX128X_BLE_GFSK_BR_0_400_BW_1_2 \
    0xB1  //  7     0                                            0.4 Mbps   1.2 MHz
#define RADIOLIB_SX128X_BLE_GFSK_BR_0_400_BW_0_6 \
    0xAA  //  7     0                                            0.4 Mbps   0.6 MHz
#define RADIOLIB_SX128X_BLE_GFSK_BR_0_250_BW_0_6 \
    0xCE  //  7     0                                            0.25 Mbps  0.6 MHz
#define RADIOLIB_SX128X_BLE_GFSK_BR_0_250_BW_0_3 \
    0xC7  //  7     0                                            0.25 Mbps  0.3 MHz
#define RADIOLIB_SX128X_BLE_GFSK_BR_0_125_BW_0_3 \
    0xEF  //  7     0                                            0.125 Mbps 0.3 MHz
...
#define RADIOLIB_SX128X_BLE_PAYLOAD_LENGTH_MAX_255 \
    0x80                                  //  7     0                               255 bytes (Bluetooth 4.2 and above)
...
#define RADIOLIB_SX128X_BLE_PRBS_15 \
    0x0C  //  7     0                              PRNG sequence using x^15 + x^14 + x^13 + x^12 + x^2 + x + 1
...
#define RADIOLIB_SX128X_PACKET_STATUS_LENGTH_ERROR \
    0b00100000                                              //  5     5                              packet length error
#define RADIOLIB_SX128X_PACKET_STATUS_CRC_ERROR 0b00010000  //  4     4                              CRC error
#define RADIOLIB_SX128X_PACKET_STATUS_ABORT_ERROR \
    0b00001000  //  3     3                              packet reception aborted
#define RADIOLIB_SX128X_PACKET_STATUS_HEADER_RECEIVED \
    0b00000100  //  2     2                              header received
#define RADIOLIB_SX128X_PACKET_STATUS_PACKET_RECEIVED \
    0b00000010  //  1     1                              packet received
#define RADIOLIB_SX128X_PACKET_STATUS_PACKET_CTRL_BUSY \
    0b00000001  //  0     0                              packet controller is busy
#define RADIOLIB_SX128X_PACKET_STATUS_RX_PID \
    0b11000000  //  7     6   packet status status byte: PID field of the received packet
#define RADIOLIB_SX128X_PACKET_STATUS_NO_ACK \
    0b00100000  //  5     5                              NO_ACK field of the received packet
...
#define RADIOLIB_SX128X_PACKET_STATUS_SYNC_DET_ERROR \
    0b00000000  //  2     0   packet status sync byte: sync word detection error
...
#define RADIOLIB_SX128X_IRQ_RANGING_SLAVE_REQ_VALID \
    0x0800                                                 //  11    11                    ranging request valid (slave)
#define RADIOLIB_SX128X_IRQ_RANGING_MASTER_TIMEOUT 0x0400  //  10    10                    ranging timeout (master)
#define RADIOLIB_SX128X_IRQ_RANGING_MASTER_RES_VALID \
    0x0200  //  9     9                     ranging result valid (master)
#define RADIOLIB_SX128X_IRQ_RANGING_SLAVE_REQ_DISCARD \
    0x0100  //  8     8                     ranging result valid (master)
#define RADIOLIB_SX128X_IRQ_RANGING_SLAVE_RESP_DONE \
    0x0080                                          //  7     7                     ranging response complete (slave)
...
/*!
  \class SX128x
  \brief Base class for %SX128x series. All derived classes for %SX128x (e.g. SX1280 or SX1281) inherit from this base
  class. This class should not be instantiated directly from Arduino sketch, only from its derived classes.
*/
class SX128x : public PhysicalLayer {
  public:
    ...
    */
    ...
    /*!
      ...
      \param cr LoRa coding rate denominator. Defaults to 7 (coding rate 4/7). Allowed values range from 4 to 8. Note
      that a value of 4 means no coding, is undocumented and not recommended without your own FEC.
    ...
    */
    int16_t begin(float freq = 2400.0,
                  float bw = 812.5,
                  uint8_t sf = 9,
                  uint8_t cr = 7,
    ...
    /*!
      ...
      \returns \ref status_codes
    */
    int16_t beginGFSK(float freq = 2400.0,
                      uint16_t br = 800,
                      float freqDev = 400.0,
                      int8_t pwr = 10,
    ...
    /*!
      ...
      \returns \ref status_codes
    */
    int16_t beginBLE(float freq = 2400.0,
                     uint16_t br = 800,
                     float freqDev = 400.0,
                     int8_t pwr = 10,
    ...
    /*!
      ...
      \returns \ref status_codes
    */
    int16_t beginFLRC(float freq = 2400.0,
                      uint16_t br = 650,
                      uint8_t cr = 3,
                      int8_t pwr = 10,
                      uint16_t preambleLength = 16,
    ...
    /*!
      ...
      \param verify Whether correct module startup should be verified. When set to true, RadioLib will attempt to verify
      the module has started correctly by repeatedly issuing setStandby command. Enabled by default.
      \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      \param wakeup Whether to force the module to wake up. Setting to true will immediately attempt to wake up the
      module.
      \returns \ref status_codes
    */
    ...
    */
    ...
    /*!
      ...
      Allowed values are RADIOLIB_SHAPING_0_5 or RADIOLIB_SHAPING_1_0. Set to RADIOLIB_SHAPING_NONE to disable data
      shaping.
    ...
    */
    ...
    /*!
      ...
      \param polynomial Polynomial for CRC calculation. Defaults to 0x1021 (CCIT CRC), not available for LoRa or BLE
      modem.
      \returns \ref status_codes
    */
  ...
  protected:
    ...
    int16_t setTx(uint16_t periodBaseCount = RADIOLIB_SX128X_TX_TIMEOUT_NONE,
                  uint8_t periodBase = RADIOLIB_SX128X_PERIOD_BASE_15_625_US);
    ...
    int16_t setPacketParamsGFSK(uint8_t preambleLen,
                                uint8_t syncLen,
                                uint8_t syncMatch,
                                uint8_t crcLen,
                                uint8_t whiten,
    ...
    int16_t setPacketParamsLoRa(uint8_t preambleLen,
                                ...
                                uint8_t payLen,
                                uint8_t crc,
                                uint8_t invIQ = RADIOLIB_SX128X_LORA_IQ_STANDARD);
    int16_t setDioIrqParams(uint16_t irqMask,
                            uint16_t dio1Mask,
                            uint16_t dio2Mask = RADIOLIB_SX128X_IRQ_NONE,
                            uint16_t dio3Mask = RADIOLIB_SX128X_IRQ_NONE);
