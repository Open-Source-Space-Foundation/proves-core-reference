...
Components that handle authentication and security features: [TcSecurityDeframer](components/TcSecurityDeframer.md), [Authentication Router](components/AuthenticationRouter.md)
